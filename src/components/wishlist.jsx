...
function wishlist() {
   const {wishListItem,setWishLisItem}=useContext(UserContext)
      ...
      
       {
         wishListItem.length>0?
           ...
           <div className=' h-106 w-75 rounded-b-lg   mb-10 mt-20'>
            ...
            <img className='w-9 h-9 absolute bottom-6' src="https://www.giva.co/cdn/shop/t/95/assets/delete-wish-item.png?v=106029573354386947881723011794" alt="" />
            <button className='  bg-zinc-900 ml-10 text-stone-50 text-lg hover:text-lg  hover:bg-yellow-600 hover:text-white
              rounded-lg cursor-pointer w-65 h-11 font-serif ' >Move to Cart</button>
            </div>
           </div>
)
:<div >
