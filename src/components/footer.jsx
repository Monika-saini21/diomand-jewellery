...
function Footer(){
    return( 
     ...
     <div >
             ...
             <h className='text-white pl-25 m-4 text-xs font-thin'>Diamond Sea is a family-run company</h><br></br>
                 ...
                 <div className="relative left-205 bottom-48 cursor-pointer h-0 w-10">
                     ...
                     <h className='font-bold text-lg  text-white'>BUYER</h>
                        ...
                        <hr className='text-gray-200 border-0.5 w-275 flex relative bottom-34 left-29'></hr>
                         <p className='flex  relative left-27 bottom-14 text-xs text-gray-200 w-90 h-0 font-thin'>© 2024 Diamondsea - All Rights Reserved.</p>
